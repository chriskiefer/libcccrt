...
#define ARMA_USE_HDF5_ALT
  ...
  #define ARMA_HDF5_INCLUDE_DIR /usr/local/Cellar/hdf5/1.8.17/include/
#endif
...
#define ARMA_AUX_LIBS -framework Accelerate;/usr/local/Cellar/hdf5/1.8.17/lib/libhdf5.dylib;/usr/local/opt/szip/lib/libsz.dylib;/usr/lib/libz.dylib;/usr/lib/libdl.dylib;/usr/lib/libm.dylib
#define ARMA_AUX_INCDIRS /usr/local/Cellar/hdf5/1.8.17/include;/usr/include;/usr/local/opt/szip/include
